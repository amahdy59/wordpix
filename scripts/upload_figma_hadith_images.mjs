...
const manifest = JSON.parse(
  await fs.readFile("src/app/learning/hadith/figmaHadithImageManifest.json", "utf8")
);
...
async function worker() {
  while (cursor < entries.length) {
    ...
    const key = `hadith/v1/images/${ref}.png`;
...
console.log(`Hadith images uploaded=${uploaded} skipped=${skipped}`);

...
- [`docs/13_REFERENCE_STACK_PROFILE_REACT_NEXT_TAILWIND_SUPABASE.md`](file:///c:/Users/AhmedMahdy/OneDrive%20-%20Advansys%20IS/Documents/Antigravity/WordPix/docs/13_REFERENCE_STACK_PROFILE_REACT_NEXT_TAILWIND_SUPABASE.md) — Reference stack profile for React, TypeScript, Tailwind 4, Untitled UI v8, Supabase RLS, IndexedDB, and Next.js boundaries.
- [`docs/14_CODING_AGENT_TASK_TEMPLATES.md`](file:///c:/Users/AhmedMahdy/OneDrive%20-%20Advansys%20IS/Documents/Antigravity/WordPix/docs/14_CODING_AGENT_TASK_TEMPLATES.md) — Standardized task templates (Features, Bugs, Components, Refactoring, Accessibility, Offline/Sync, Completion Requests, and Code Reviews).

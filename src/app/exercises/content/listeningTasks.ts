  ...
  "listen-word-match": {
    ...
    tasks: [
      ...
      },
      {
        ...
        options: describeOptions("duvet", ["blanket", "sheet", "quilt"]),
        explanation: `A ${word("duvet").label.toLowerCase()} is filled and used alone; a blanket is woven, and a quilt is patched.`,
      },
    ],
  },

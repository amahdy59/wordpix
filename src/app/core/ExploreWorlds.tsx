        ...
        <div className="bg-wp-card rounded-3xl border-2 border-primary/40 p-6 flex flex-col md:flex-row gap-6 shadow-wp-md relative overflow-hidden">
          ...
          <div className="flex-1 flex flex-col justify-between gap-4">
            ...
            <button
              ...
              className="bg-wp-blue hover:opacity-90 active:opacity-80 rounded-xl py-3.5 px-6 font-sans font-bold text-white text-sm focus-visible:outline focus-visible:outline-[3px] focus-visible:outline-offset-2 focus-visible:outline-wp-blue shadow-wp-xs transition-all flex items-center justify-center gap-2 self-start mt-2 min-h-[48px]"
            >

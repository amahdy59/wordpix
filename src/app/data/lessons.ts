...
export const BEDROOM_GROUPS: Lesson[] = [
  ...
  },
  {
    ...
    name: "Room Features",
    topicId: "features",
    wordIds: ["window", "door", "blinds", "curtain", "outlet"],
    description: "Basic architectural features and fixtures in a bedroom.",
  },
  {
    id: "lighting-and-floors",
    name: "Lighting & Floors",
    topicId: "features",
    wordIds: ["rug", "carpet", "ceiling-light", "light-switch", "reading-light"],
    description: "Floor coverings and ways to light up your room.",
  },
  {
    id: "bedroom-decor",
    name: "Bedroom Decor",
    topicId: "objects",
    wordIds: ["picture-frame", "plant", "vase", "candle", "poster"],
    description: "Decorative items that make a bedroom feel cozy.",
  },
  {
    id: "time-and-organization",
    name: "Time & Organization",
    topicId: "objects",
    wordIds: ["clock", "alarm-clock", "calendar", "hanger", "chest-of-drawers"],
    description: "Items to keep track of time and organize your things.",
  },
  {
    id: "storage-solutions",
    name: "Storage Solutions",
    topicId: "objects",
    wordIds: ["laundry-basket", "wastebasket", "toy-box", "shelf", "jewelry-box"],
    description: "Places to store your belongings and keep the room tidy.",
  },
  {
    id: "personal-comfort",
    name: "Personal Comfort",
    topicId: "personal",
    wordIds: ["pajamas", "slippers", "robe", "teddy-bear", "bed-frame"],
    description: "Comfortable items for winding down at the end of the day.",
  },
  {
    id: "hobbies-and-memories",
    name: "Hobbies & Memories",
    topicId: "personal",
    wordIds: ["books", "photo-album", "backpack", "headboard", "glasses"],
    description: "Personal belongings, hobbies, and reading accessories.",
  },
  {
    id: "essential-electronics",
    name: "Essential Electronics",
    topicId: "electronics",
    wordIds: ["phone", "charger", "laptop", "headphones", "tablet"],
    description: "Must-have digital devices for communication and work.",
  },
  {
    id: "entertainment-and-extras",
    name: "Entertainment & Extras",
    topicId: "electronics",
    wordIds: ["speaker", "remote-control", "tissue-box", "desk", "lamp"],
    description: "Accessories for entertainment and daily convenience.",
  },
];

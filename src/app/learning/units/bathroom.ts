...
export const BATHROOM_LEARNING: UnitLearningMaterials = {
  ...
  subtopics: [
    {
      ...
      wordIds: [
        ...
        "drain", "mirror", "towel-rack", "cabinet", "tiles",
      ],
    },
    {
      id: "toiletries",
      ...
      wordIds: [
        ...
        "towel", "comb", "hairbrush", "lotion", "deodorant",
      ],
    },
    {
      ...
      wordIds: [
        "toilet-paper", "cotton-balls", "cotton-swab", "razor", "nail-clipper",
        "hair-dryer", "scale", "laundry-basket", "first-aid-kit", "thermometer",
      ],
    },
    {
      id: "bath-shower",
      title: "Bath & Shower",
      wordIds: [
        "bath-mat", "shower-curtain", "shower-head", "bath-towel", "hand-towel",
        "washcloth", "soap-dish", "shampoo-bottle", "rubber-duck", "shower-gel",
      ],
    },
    {
      id: "personal-care",
      title: "Personal Care",
      wordIds: [
        "face-cream", "sunscreen", "lip-balm", "hand-soap", "body-wash",
        "mouthwash", "dental-floss", "face-wash", "hand-sanitizer", "wet-wipes",
      ],
    },
    {
      id: "cleaning-items",
      ...
      wordIds: [
        "sponge", "brush", "bucket", "gloves", "spray-bottle",
        "cloth", "plunger", "squeegee", "tissue", "wash-hands",
        "brush-teeth", "take-shower", "dry-off", "flush", "comb-hair",
        "apply-lotion", "gargle",
      ],
    },
  ],
  ...
  passage: {
    ...
    level: "B1",
    text:
      "Every morning starts in the bathroom. You turn on the faucet at the sink to wash your hands with hand soap and warm water. Then you squeeze toothpaste onto your toothbrush and brush your teeth for two minutes. After that, you might gargle with mouthwash to keep your breath fresh. Next, it is time for a shower. You step into the bathtub, pull the shower curtain closed, and adjust the shower head. You use shower gel or body wash to clean your body, and shampoo followed by conditioner for your hair. When you are finished, you dry off with a bath towel and step onto the bath mat. In front of the mirror, you comb your hair with a comb or hairbrush. Many people apply lotion or face cream to keep their skin soft. Others use deodorant and sunscreen before getting dressed. The cabinet above the sink holds everyday items like dental floss, cotton swabs, a razor, and nail clippers. It is important to keep the bathroom clean. A sponge and spray bottle help wipe down the tiles and sink. The laundry basket collects used towels and washcloths, and the plunger stays beside the toilet — just in case.",
    questions: [
      {
        id: "bathroom-q1",
      ...
      },
      {
        ...
        correctIndex: 3,
        explanation:
          "The passage says the laundry basket collects used towels and washcloths.",
      },
    ],
  },
  ...
  dialogue: {
    ...
    lines: [
      ...
      { speaker: "Ali", text: "Yes, I used the toothbrush and toothpaste. And I even used mouthwash!" },
  ...
  blankExercises: [
    { id: "bathroom-b1", sentence: "I squeeze ____ onto my toothbrush every morning.", answer: "toothpaste" },
    { id: "bathroom-b2", sentence: "Don't forget to close the ____ curtain before you turn on the water.", answer: "shower" },
    { id: "bathroom-b3", sentence: "She dried her hair with the ____ after her shower.", answer: "hair dryer" },
    { id: "bathroom-b4", sentence: "Put the dirty towels in the ____ basket, please.", answer: "laundry" },
    { id: "bathroom-b5", sentence: "He stepped out of the bathtub onto the bath ____.", answer: "mat" },
    { id: "bathroom-b6", sentence: "Use ____ to clean between your teeth after brushing.", answer: "dental floss" },
    { id: "bathroom-b7", sentence: "The ____ above the sink shows your reflection.", answer: "mirror" },
    { id: "bathroom-b8", sentence: "Turn on the ____ to get hot or cold water from the sink.", answer: "faucet" },
    { id: "bathroom-b9", sentence: "She keeps her ____ and conditioner on the shelf in the shower.", answer: "shampoo" },
    { id: "bathroom-b10", sentence: "After your shower, ____ off with a clean towel.", answer: "dry" },
  ],
  ...
  wordMeta: [
    { word: "towel", partOfSpeech: "n", frequency: 3, collocations: ["bath ~", "hand ~", "~ rack", "dry with a ~"] },
    { word: "shower", partOfSpeech: "n / v", frequency: 3, collocations: ["take a ~", "~ gel", "~ head", "hot ~"] },
    { word: "soap", partOfSpeech: "n", frequency: 3, collocations: ["bar of ~", "hand ~", "~ dish", "~ dispenser"] },
    { word: "faucet", partOfSpeech: "n", frequency: 2, collocations: ["turn on/off the ~", "hot water ~", "dripping ~"] },
    { word: "mirror", partOfSpeech: "n", frequency: 3, collocations: ["look in the ~", "bathroom ~", "side ~"] },
    { word: "shampoo", partOfSpeech: "n / v", frequency: 2, collocations: ["~ bottle", "~ and conditioner", "~ your hair"] },
    { word: "toothbrush", partOfSpeech: "n", frequency: 3, collocations: ["electric ~", "~ holder", "~ and toothpaste"] },
    { word: "drain", partOfSpeech: "n / v", frequency: 2, collocations: ["clogged ~", "~ the water", "down the ~"] },
    { word: "bathtub", partOfSpeech: "n", frequency: 2, collocations: ["fill the ~", "sit in the ~", "~ drain"] },
    { word: "razor", partOfSpeech: "n", frequency: 2, collocations: ["safety ~", "electric ~", "disposable ~", "~ blade"] },
  ],
};
